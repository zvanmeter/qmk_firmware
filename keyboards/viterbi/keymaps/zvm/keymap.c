...
#define KC_LC_ESC LCTL_T(KC_ESC)
#define KC_LAY1 MO(_LOWER)
...
/* QWERTY */
  [_QWERTY] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
     GRV , 1  , 2  , 3  , 4  , 5  , EQL,      X  , 6  , 7  , 8  , 9  , 0  ,MINS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     TAB , Q  , W  , E  , R  , T  , X  ,     RBRC, Y  , U  , I  , O  , P  ,LBRC,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
      X  , A  , S  , D  , F  , G  , X  ,     BSLS, H  , J  , K  , L  ,SCLN,QUOT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LSFT, Z  , X  , C  , V  , B  , X  ,      X  , N  , M  ,COMM,DOT ,SLSH,RSFT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LGUI,VOLD,VOLU,LALT,LC_ESC,BSPC,DEL,    ENT ,SPC ,RGUI,LAY1, UP ,RGHT,BSLS
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
